            ...
            <>
              {!editMode ? (
                <div className="space-y-2 mb-4">
                  <p>
                    <strong>ספינים חודשיים:</strong> {settings.monthlySpins}
                  </p>
                  <p>
                    <strong>ספינים רבעוניים:</strong> {settings.quarterlySpins}
                  </p>
                  <p>
                    <strong>שעות איפוס:</strong> {settings.monthlySpinResetHours}
                  </p>
                  <button
                ...
                <div className="space-y-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, monthlySpins: parseInt(e.target.value) })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, quarterlySpins: parseInt(e.target.value) })
                      }
                      className="w-full border rounded px-3 py-2"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          monthlySpinResetHours: parseInt(e.target.value),
                        })
                      }
                      className="w-full border rounded px-3 py-2"
                    />
