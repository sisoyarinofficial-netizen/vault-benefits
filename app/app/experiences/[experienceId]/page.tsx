...
export default function SpinWheelPage() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      try {
        setLoading(true);
        const res = await fetch(`/api/user?userId=${userId}&experienceId=${experienceId}`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center p-4" dir="rtl">
      <div className="text-center">
        ...
        <div className="mb-12 relative w-72 h-72 mx-auto">
          ...
          >
            {prizes.map((prize, i) => (
              <div key={i} className="flex items-center justify-center text-white font-bold text-sm drop-shadow-lg">
                <div className="text-center">
